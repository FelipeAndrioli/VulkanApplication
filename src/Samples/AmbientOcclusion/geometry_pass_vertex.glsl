...
layout (location = 0) out vec3 out_frag_normal;
layout (location = 1) out vec3 out_frag_color;
layout (location = 2) out vec3 out_frag_tangent;
...
//	out_frag_pos		= view_pos.xyz;
    ...
    gl_Position = scene_gpu_data.projection * scene_gpu_data.view * push_constants.model * vec4(in_position, 1.0);
}
