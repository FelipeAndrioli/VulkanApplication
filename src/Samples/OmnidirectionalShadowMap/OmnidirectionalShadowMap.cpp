...
void OmnidirectionalShadowMap::ColorPassStartUp() {
	...
	m_SceneInputLayout = {
		...
		.bindings = {
			...
			{ 2, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER, 1, VK_SHADER_STAGE_FRAGMENT_BIT }	// Cube Shadow Map
		}
	};
...
void OmnidirectionalShadowMap::StartUp() {
	...
	m_OmniDirectionalRenderTarget	= std::make_unique<Graphics::DepthOnlyCubeRenderTarget>(m_Width, m_Width, 0, 0);
